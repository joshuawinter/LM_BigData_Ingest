Name:           flume_prod_edge
Version:        2.0
Release:        1%{?dist}
Summary:        Flume configuration files for production edge nodes.
...
%description
Configuration files to move data to agent nodes.
...
install -m 755 edge/flume/flume.conf $RPM_BUILD_ROOT/etc/flume/conf/%{name}.conf
