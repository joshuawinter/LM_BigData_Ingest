...
install -m 755 admin/falcon/archive_%{gname}.xml $RPM_BUILD_ROOT%{fconf}/archive_%{gname}.xml
install -m 755 admin/falcon/lz_%{gname}.xml $RPM_BUILD_ROOT%{fconf}/lz_%{gname}.xml
install -m 755 admin/falcon/process_%{gname}.xml $RPM_BUILD_ROOT%{fconf}/process_%{gname}.xml
...
%changelog
* Mon Dec  2 2014 Alan Brenner <alan.brenner@teradata.com> 2.1
- Google has dropped MaxCpc, discovered by John Morgan.
